    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-lg-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Primary Switch Request</span></h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{ route('primarychangerequest.index') }}" class="breadcrumb-item">Primary Switch Request</a>
            ...
            <div class="modal fade" id="approveModalCenter_{{$primary->id}}" tabindex="-1" role="dialog" aria-labelledby="approveModalCenter_{{$primary->id}}Title" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{route('primarychangerequest.approve',$primary->id)}}" method="POST">
                            @csrf
            ...
            <div class="modal fade" id="rejectModal" tabindex="-1" role="dialog" aria-labelledby="rejectModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <form action="{{route('primarychangerequest.reject',$primary->id)}}" method="post">
                        @csrf
                        <div class="modal-body">
