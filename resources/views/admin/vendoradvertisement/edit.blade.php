...
@section('content')
    ...
    <div class="card">
        <form method="POST" action="{{ route('vendorads.update', $advertisement->id) }}" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @method('patch')
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select name="position" class="form-control">
                                ...
                                <option value="Top" @if($advertisement->position == 'Top') selected @endif>Top</option>
                                <option value="Buttom" @if($advertisement->position == 'Buttom') selected @endif>Buttom</option>
                                <option value="Left" @if($advertisement->position == 'Left') selected @endif>Left</option>
                                <option value="Right" @if($advertisement->position == 'Right') selected @endif>Right</option>
                                <option value="Middle" @if($advertisement->position == 'Middle') selected @endif>Middle</option>
                            </select>
                            @error('title')
                                <div class="alert alert-danger">
                                    {{ $message }}
