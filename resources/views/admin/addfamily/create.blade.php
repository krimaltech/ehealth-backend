...
@section('content')
    ...
    <div class="card">
        <form method="POST" action="{{ route('addfamily.store') }}" class="form-horizontal"
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label class="form-label">Family Phone no<code>*</code></label>
                            <input type="text" class="form-control" name="family_id" placeholder="+97798********" required>
                            @error('family_id')
