...
@section('content')
    ...
    <div class="card">
        <form method="POST" action="{{ route('expo.store') }}" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-9">
                        <div class="form-group">
                            ...
                            <textarea class="summernote form-control" name="description" value="{{ old('description') }}" cols="30" rows="10"></textarea>
                        </div>
                    </div>
                    <div class="col-lg-3">
