    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-lg-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Insurance Claim Report - Death Insurance Claim</span></h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Insurance Claim Report - Death Insurance Claim</span>
                </div>
            ...
            <table class="table table-bordered table-hover datatable-colvis-basic">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @endif
                        <td>
                            <a href="{{route('deathinsuranceclaim.show',$item->slug)}}" class="btn btn-primary"><i class="icon-eye2"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
