    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-lg-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">View</span> - Insurance Claim Report - Other Insurance Claim</h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{ route('insuranceclaim.index') }}" class="breadcrumb-item">Insurance Claim Report - Other Insurance Claim</a>
    ...
    <div class="card my-3">
        ...
        <div class="card-body mt-4">
            ...
            <table class="table my-3">
                <tr>
                    <th>User Name</th>
                    <td>{{ $insuranceClaim->user->name }}</td>
                </tr>
                <tr>
                    <th>User Email</th>
                    <td>{{ $insuranceClaim->user->email }}</td>
                </tr>
                <tr>
                    <th>User Phone</th>
                    <td>{{ $insuranceClaim->user->phone }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <form action="{{ route('insuranceclaim.changestatus', $insuranceClaim->slug) }}" method="POST">
                        @csrf
                        @method('patch')
                        <div class="row">
                            <div class="col-lg-6">
