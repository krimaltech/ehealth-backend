...
@section('content')
    ...
    <div class="card">
        <form method="POST" action="{{ route('vendorslider.update',$banner->slug) }}" class="form-horizontal"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="banner_body" value="{{ $banner->banner_body }}">
                            @error('banner_body')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
