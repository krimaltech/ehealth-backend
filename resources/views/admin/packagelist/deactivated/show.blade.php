        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{ route('deactivated.index') }}" class="breadcrumb-item">Deactivated Package List</a>
                    ...
                    <div  class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <p><span style="font-weight:500">Lab Screening Date :</span> {{$item->screening_date}}</p>  
                                ...
                                @endif
                            <p><span style="font-weight:500">Screening Status :</span> @if($item->status == 'Pending') In Progress @else {{$item->status}} @endif  
                                @if($item->consultation_type == 1)
                                <span class="mb-0 text-info">(Physical Consultation)</span>
                                @elseif($item->consultation_type == 2)
                                <span class="mb-0 text-info">(Online Consultation)</span>
                                @endif</p>  
