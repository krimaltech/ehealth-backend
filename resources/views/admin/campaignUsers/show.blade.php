    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-lg-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">View</span> - Campaign Users
                </h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    @if($screening->campaign->status == 1)
                    <a href="{{ route('campaignusers.index') }}" class="breadcrumb-item">Campaign Users</a>
                    @else
                    <a href="{{ route('completedcampaignusers.index') }}" class="breadcrumb-item">Campaign Users</a>
                    @endif
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    <p><span style="font-weight:600">Campaign / Campaign No.: </span>{{ $screening->campaign->title }} /
                        {{ $screening->campaign->campaign_no }}</p>
                    <p><span style="font-weight:600">Username: </span>{{ $screening->user_name }}</p>
                </div>
                @if ($screening->campaign->status == 0)
                    <div class="text-right">                        
                        @if ($screening->pdf)
                            <a href="{{ $screening->pdf_path }}" target="_blank" class="btn btn-primary mt-2">View PDF :
                                {{ $screening->pdf }}</a>
                            ...
                            {{-- <div class="btn-group mt-2">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <form action="{{ route('campaignusers.sendReportEmail', $screening->id) }}"
                                        method="post">
                                        @csrf
                                        <button type="submit" class="dropdown-item"><i class="icon-paperplane"></i>
                                            Via Email</button>
                                    </form>

                                    <a href="https://api.whatsapp.com/send/?phone={{ $screening->campaignuser->phone }}&text=GD Campaign Report PDF link: {{ $screening->pdf_path }}"
                                        target="_blank" class="dropdown-item">
                                        <i class="icon-paperplane"></i> Via Whatsapp
                                    </a>
            ...
            <table class="table">
                ...
                @if ($screening->campaign->campaign_type == 'School')
                    <tr>
                        <th>User Type</th>
                        <td>{{ $screening->campaignuser->user_type }}</td>
                    </tr>
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="nurse" role="tabpanel" aria-labelledby="nurse-tab">
                    @if ($screening->nurse)
                        ...
                        <p><span style="font-weight: 600">5. Drug History : </span>{{ $screening->nurse->drug_history }}
                        </p>
                ...
                <div class="tab-pane fade" id="ophthalmologist" role="tabpanel" aria-labelledby="ophthalmologist-tab">
