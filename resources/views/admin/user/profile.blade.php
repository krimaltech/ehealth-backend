    ...
    <div class="page-header page-header-light">
          <div class="breadcrumb-line breadcrumb-line-light">
            <div class="breadcrumb breadcrumb-arrows">
                ...
                <span class="breadcrumb-item active">Profile Change</span>
            </div>
        </div>
    </div>
</div>
...
<div class="card" style=" width:50%;" >
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{route('profile.update', $user->id)}}" class="form-horizontal" enctype="multipart/form-data">
            @csrf
         @method('put')
            <div class="row">
                <div class="col-md-9">
                ...
                <div class="col-md-9">
                    <label for="email" class="required">Email</label>
                        <input disabled type="email" name="email"  id="email" class="form-control" value="{{ null !== old('email') ? old('email') : (isset($user) ? $user->email : '') }}" required   />
                     @if ($errors->has('email'))
             ...
             <div class="col-md-9">
                    <label for="password" >Password Confirm</label>
                        <input type="password" name="password_confirmation"  id="confirmed" class="form-control"  />
