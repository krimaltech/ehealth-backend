...
@section('content')
    <div class="card">
        <div class="card-header border-bottom">
            <a href="{{ route('nurse-screening-form.create') }}" type="button" class="btn btn-primary">
                Add Nurse Screening Form
            </a>
        </div>
        <div class="card-body">
            <table class="table table-bordered table-hover datatable-colvis-basic">
                ...
                <tbody>
                    @foreach ($nurseScreeningForm as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('nurse-screening-form.show', $item->id) }}" class="btn btn-primary"><i
                                        class="icon-eye"></i> </a>
                                <a href="{{ route('nurse-screening-form.edit', $item->id) }}" class="btn btn-primary"><i
                                        class="icon-pen"></i> </a>
                            </td>
                        </tr>
                    @endforeach
