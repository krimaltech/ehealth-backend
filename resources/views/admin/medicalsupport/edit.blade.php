...
@section('content')
    ...
    <div class="card">
        <form method="POST" action="{{ route('medical-support.update',$medicalSupport->id) }}" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @method('patch')
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title" value="{{ $medicalSupport->title }}"
                                required>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" class="form-control" name="price" value="{{ $medicalSupport->price }}"
                                required>
                        </div>
                    </div>
                </div>
