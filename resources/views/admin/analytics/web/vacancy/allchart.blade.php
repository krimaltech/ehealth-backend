<div class="chart_container" id="analytics_chart_{{ $chartId }}"></div>
...
{{-- <script>
    ...
    google.charts.setOnLoadCallback(alldrawChart_{{ $chartId }});

    function alldrawChart_{{ $chartId }}() {
        ...
        var chart = new google.visualization.LineChart(document.getElementById('analytics_chart_{{ $chartId }}'));

        chart.draw(data, options);
    }
</script> --}}
<script>
    $('#all-{{$id}}-tab').on('shown.bs.tab', function (e,$chartId) {
        // Get the chart container element
        var chartContainer = document.getElementById('analytics_chart_{{ $chartId }}');
