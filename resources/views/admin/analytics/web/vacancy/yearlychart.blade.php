<div class="chart_container" id="yearly_analytics_chart_{{$chartId}}"></div>
...
{{-- <script>
    ...
    google.charts.setOnLoadCallback(yearlydrawChart_{{ $chartId }});

    function yearlydrawChart_{{ $chartId }}() {
        ...
        var chart = new google.visualization.LineChart(document.getElementById('yearly_analytics_chart_{{ $chartId }}'));

        chart.draw(data, options);
    }
</script> --}}
<script>
    $('#yearly-{{$id}}-tab').on('shown.bs.tab', function (e,$chartId) {
        // Get the chart container element
        var chartContainer = document.getElementById('yearly_analytics_chart_{{ $chartId }}');
