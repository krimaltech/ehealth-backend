        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Director</span>
                </div>
...
@section('content')
    <div class="card">
        <div class="card-header border-bottom">
            <a href="{{ route('director.create') }}" type="button" class="btn btn-primary">
                Add Director
            </a>
        </div>
        <div class="card-body">
                ...
                <tbody>
                    @foreach ($director as $item)
                        <tr>
                            ...
                            @endif
                            <td>
                                <a href="{{ route('director.show', $item->id) }}" class="btn btn-primary"><i
                                        class="icon-eye"></i> </a>
                                <a href="{{ route('director.edit', $item->id) }}" class="btn btn-primary"><i
                                        class="icon-pen"></i> </a>
                            </td>
                        </tr>
                    @endforeach
