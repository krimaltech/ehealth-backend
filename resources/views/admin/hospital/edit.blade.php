...
@section('content')
    ...
    <div class="card">
        <form method="POST" action="{{ route('hospital.update',$hospital->id) }}" class="form-horizontal"
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required name="name" value="{{old('name') ?? $hospital->name }}">
                            @error('name')
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required name="address" value="{{old('address') ?? $hospital->address }}">
                            @error('address')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" required name="email" value="{{old('email') ?? $hospital->email }}">
                            @error('email')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required name="phone" value="{{old('phone') ?? $hospital->phone }}">
                            @error('phone')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="latitude" id="latitude"
                                value="{{old('latitude') ?? $hospital->latitude}}" readonly>
                            @error('latitude')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            value="{{old('longitude') ?? $hospital->longitude}}" readonly>
                            @error('longitude')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="col-lg-4 mb-4">
                        ...
                        <img src="{{ asset('/storage/images/' . $hospital->image) }}" alt="" height="200px"
                            width="250px">
