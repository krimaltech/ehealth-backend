    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-lg-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Remove Family Request</span></h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Remove Family Request</span>
                </div>
                        ...
                        <td>
                                ...
                                <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="approveModalLongTitle">Approve Remove Request</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <form action="{{route('removerequest.approve',$item->id)}}" method="POST">
                                            @csrf
                                            <div class="modal-body">
                                                <label for="">Do you really want to approve this remove request?</label>
                                            </div>
                            ...
                            <div class="modal fade" id="rejectModalCenter_{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="rejectModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="rejectModalLongTitle">Reject Remove Request</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <form action="{{route('removerequest.reject',$item->id)}}" method="POST">
                                            @csrf
                                            <div class="modal-body">
                                                <label for="">Reject Reason</label>
                                                <textarea name="reject_reason" id="" cols="30" rows="3" required class="form-control"></textarea>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
