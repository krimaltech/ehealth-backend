    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-lg-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Edit</span> - Vendor Profile
                </h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{ route('vendor.index') }}" class="breadcrumb-item">Vendor Profile</a>
...
@section('content')
    ...
    <div class="card">
        <form method="POST" action="{{ route('vendor.update', $vendor->slug) }}" class="form-horizontal"
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" value="{{ $vendor->user->name }}">
                            @error('name')
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="email" value="{{ $vendor->user->email }}" disabled>
                            @error('email')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="tel" id="phone1" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{$vendor->user->phone}}" disabled>
