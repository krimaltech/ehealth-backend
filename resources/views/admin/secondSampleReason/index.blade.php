        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Second Sample Uncollected Reason</span>
                </div>
                ...
                <tbody>
                    @foreach ($reason as $item)                      
                        <tr>
                            ...
                            <td>{{count($item->additionalnosample)}}</td>
                            <td>
                                <a href="{{route('secondSampleReason.show',$item->id)}}" class="btn btn-primary">
                                    <i class="icon-eye2"></i>
                                </a>
                            </td>
                        </tr>                       
