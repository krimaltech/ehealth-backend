...
<body>
    ...
    overflow: hidden;">
        ...
        margin-top: 30px;
        padding: 20px;">
            <h2 style="margin: auto;">invoice # {{ $mailData['order_number'] }}</h2>
            <p style=" margin-top: 5px; text-align: left;">Invoice Date: {{ $mailData['date'] }}
        </div>
        <div class="section1">
            <h3 style="margin-top:40px; margin: 0; margin-top:40px;">Invoiced To</h3>
            <p style="align-items: right; margin: 0;">Jaruwa Nepal Pvt. Ltd. <br>ATTN: {{ $mailData['name'] }}
            </p>
        </div>
        <div class="status"
        ...
        <table class="table"style="width:100%">
            ...
            <tbody>
                <tr>
                    <td><strong> {{ $mailData['order_number'] }}</strong></td>
                    <td><strong> {{ $mailData['payment_status'] }}</strong></td>
                    <td><strong> {{ $mailData['payment_method'] }}</strong></td>
                    <td><strong> {{ $mailData['date'] }}</strong></td>
