      ...
      ">
        ...
        ">
            <div class="uniform-padding" style="padding: 40px">
                ...
                <div class="mail-info">
                    <b>Hello {{$refer['name']}},</b>
                    <p class="text-muted" style="padding: 0; margin: 0 0 15px 0; color: #6c757d !important">
                        Press below link register
                    </p>
                </div>
                <div style="padding-bottom: 10px"><a href="{{$refer['web_url']}}" class="btn btn-primary">Register with WEB</a></div>
                <div><a href="{{$refer['mobile_url']}}" class="btn btn-primary">Register with Mobile</a></div>
            </div>
