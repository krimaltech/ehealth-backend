...
<body>
    ...
    <div class="card">
        <div class="card-body">
            <p>Hi </p>
            <p>Your order #{{ $mailData['order-number'] }} has been placed successfully.
            </p><br>
            <h3>Delivery Detials</h3>
        ...
        <table style="border: 1px solid black;">
            ...
            @foreach ($mailData['products'] as $item)
                <tr>
                    ...
                    <td>{{ $item->name }}</td>
                    <td><img src="{{ $item->image_path }}" alt="" srcset="" height="50px" width="50px"></td>
                    <td>{{ $item->quantity }}</td>
                    <td>{{ $item->price }}</td>
                </tr>
            @endforeach
        ...
        <div class="card" style="background-color: #fff;border: 1px solid #DFDFDF;width: 70%;margin: auto;">
            <div class="uniform-padding" style="padding: 40px;">
                ...
                <div class="mail-title">
                    <h2 style="padding: 0;margin: 0 0 15px 0;"><b>Your Order is confirmed</b></h2>
                </div>
                <div class="mail-info">
                    <b>Hello {{ $mailData['name'] }},</b>
                    <p class="text-muted" style="padding: 0;margin: 0 0 15px 0;color: #6c757d !important;">Your order
                        has been confirmed and will be shipped right away.</p>
                </div>
                ...
                <div class="mail-order-details mt-3" style="margin-top: 1rem;">
                    ...
                    <div class="order-items-table mt-3" style="margin-top: 1rem;">
                        @php
                            $subtotal = 0;
                            foreach ($mailData['products'] as $key => $value) {
                        ...
                        <table
                            ...
                            @foreach ($mailData['products'] as $item)
                                <tr classname="order-item-row">
                                    ...
                                    <td>
                                        <span class="company-txt" style="color: #045AA7;font-size: 1.2em;"><b>Rs.
                                                {{ $item->price * $item->quantity }}</b></span>
                                    </td>
                                </tr>
                            @endforeach
                ...
                <div class="order-summary py-3"
                    style="padding-top: 1rem;padding-bottom: 1rem;align-items: end;border-bottom: 1px solid #D7D7D7; text-align:right;">
                    <div class="summary-item" style="margin-bottom: 10px;">
                        <span class="summary-label" style="margin-right: 40px;">Subtotal</span>
                        <span><b>Rs {{ $subtotal }}</b></span>
                    </div>
                    <div class="summary-item" style="margin-bottom: 10px;">
                    ...
                    <div class="summary-item" style="margin-bottom: 10px;">
                        <span class="summary-label" style="margin-right: 40px;">VAT(13%)</span>
                        <span><b>Rs ...</b></span>
                    </div>
