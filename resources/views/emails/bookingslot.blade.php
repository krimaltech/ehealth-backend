...
<body>
    ...
    overflow: hidden;">
        ...
        margin-top: 30px;
        padding: 20px;">
            <h2 style="margin: auto;">invoice # {{ $mailData['booking_status'] }}</h2>
            <p style=" margin-top: 5px; text-align: left;">Invoice Date: {{ $mailData['payment_date'] }}
        </div>
        <div class="section1">
        ...
        <table class="table"style="width:100%">
            ...
            <tbody>
                <tr>
                    <td><strong> {{ $mailData['booking_status'] }}</strong></td>
                    <td><strong> {{ $mailData['payment_date'] }}</strong></td>
