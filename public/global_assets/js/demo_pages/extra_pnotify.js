...
var Pnotify = function() {
    ...
    var _componentPnotify = function() {
        ...
        $('#pnotify-solid-success').on('click', function () {
            new PNotify({
                title: 'Success notice',
                text: document.getElementById('pnotify-solid-success').innerHTML,
        ...
        $('#pnotify-solid-warning').on('click', function () {
            new PNotify({
                ...
                text: document.getElementById('pnotify-solid-warning').innerHTML,
                addclass: 'bg-warning border-warning text-white'
            });
        });
        $('#pnotify-solid-warning2').on('click', function () {
            new PNotify({
                title: 'Warning notice',
                text: document.getElementById('pnotify-solid-warning2').innerHTML,
                addclass: 'bg-warning border-warning text-white'
            });
        });
