...
!(function (e) {
    ...
    (t = {
        ...
        ifSet: function (e, t, i) {
            return (
                (i = i || ""), t && "object" == typeof t && e in t ? t[e] : i
            );
        },
        ...
        (i.prototype = {
            ...
            _init: function (i, a) {
                ...
                (s.options = i),
                    ...
                    s.rtl &&
                        ...
                        (s.previewZoomButtonIcons.prev =
                            s.previewZoomButtonIcons.next),
                    ...
                    (s.dropZoneEnabled =
                        t.hasDragDropSupport() && s.dropZoneEnabled),
                    s.isAjaxUpload ||
                        (s.dropZoneEnabled =
                    ...
                    (s.previewGenericTemplate =
                        s._getPreviewTemplate("generic")),
                    !s.imageCanvas &&
                        s.resizeImage &&
                        (s.maxImageWidth || s.maxImageHeight) &&
                        ((s.imageCanvas = document.createElement("canvas")),
                        (s.imageCanvasContext =
                            s.imageCanvas.getContext("2d"))),
                    ...
                    (s.$captionIcon =
                        s.$captionContainer.find(".file-caption-icon")),
                    ...
                    a
                        ...
                        : (s.$errorContainer.hide(),
                          ...
                          s.$parent.hasClass("file-loading") &&
                              (s.$container.insertBefore(s.$parent),
                              s.$parent.remove())),
                    s._setFileDropZoneTitle(),
                    d.attr("disabled") && s.disable(),
                    s._initZoom(),
                    s.hideThumbnailContent &&
                        t.addCss(s.$preview, "hide-content");
            },
                            ...
                            ? ((r = void 0 === r ? !0 : r),
                              ...
                              (n = h
                                  ...
                                  : w(
                                        ...
                                        p,
                                        l
                                    ).setTokens({ content: f.content[a] })),
                              f.tags.length &&
                                  f.tags[a] &&
                                  (n = t.replaceTags(n, f.tags[a])),
                              t.isEmpty(m) ||
                                  t.isEmpty(m.frameAttr) ||
                                  ((o = e(document.createElement("div")).html(
                                      n
                                  )),
                                  o
                    ...
                    footer: function (e, a, r) {
                        ...
                        var o,
                            ...
                            h = t.ifSet(
                                "showRemove",
                                l,
                                t.ifSet("showRemove", u, f)
                            ),
                            w = t.ifSet(
                                "showDownload",
                                l,
                                t.ifSet("showDownload", u, g)
                            ),
                            _ = t.ifSet(
                                "showZoom",
                                l,
                                t.ifSet("showZoom", u, !0)
                            ),
                            b = t.ifSet(
                                "showDrag",
                                l,
                                t.ifSet("showDrag", u, !0)
                            ),
                            C = c === !1 && a;
                        return (
            ...
            _parseError: function (t, i, a, r) {
                var n,
                    ...
                    l = e.trim(a + ""),
                    s =
                        void 0 !== i.responseJSON &&
                        void 0 !== i.responseJSON.error
                            ? i.responseJSON.error
                            : i.responseText;
                return (
                    o.cancelling &&
                        o.msgUploadAborted &&
                        (l = o.msgUploadAborted),
            ...
            _zoneDragEnter: function (i) {
                ...
                return (
                    ...
                    a.isDisabled || !n
                        ? ((i.originalEvent.dataTransfer.effectAllowed =
                              "none"),
                          void (i.originalEvent.dataTransfer.dropEffect =
                              "none"))
                        : void (
            ...
            _initPreview: function (e) {
                ...
                return a.previewCache.count()
                    ? ((i = a.previewCache.out()),
                      (r =
                          e && a.initialCaption ? a.initialCaption : i.caption),
            ...
            _maximizeZoomDialog: function () {
                ...
                i.addClass("file-zoom-fullscreen"),
                    ...
                    n &&
                        n.length &&
                        ((l = n.outerHeight(!0) - n.height()), (o -= l)),
            ...
            _getFrame: function (t) {
                ...
                return a.length
                    ? a
                    : (i._log('Invalid thumb frame with id: "' + t + '".'),
                      null);
            },
                    ...
                    e.upload &&
                        e.upload.addEventListener(
                            ...
                            function (e) {
                                ...
                                e.lengthComputable &&
                                    (r = Math.floor((o / n) * 100)),
                                    t
                                        ? a._setAsyncUploadStatus(t, r, i)
                                        : a._setProgress(r);
                            },
                            !1
                        ),
            ...
            _ajaxSubmit: function (t, i, a, r, n, o) {
                ...
                d._raise("filepreajax", [n, o]) &&
                    ...
                    (s =
                        o && d.uploadUrlThumb ? d.uploadUrlThumb : d.uploadUrl),
                    (l = e.extend(
                        !0,
                        {},
                        {
            ...
            _initSuccessThumbs: function () {
                ...
                i.showPreview &&
                    i
                        ._getThumbs(t.FRAMES + ".file-preview-success")
                        .each(function () {
                            var a = e(this),
                                r = i.$preview,
            ...
            _uploadSingle: function (i, a) {
                var r,
                    ...
                    w = v.previewInitId + "-" + i,
                    _ =
                        v.filestack.length > 0 ||
                        !e.isEmptyObject(v.uploadExtraData),
                    ...
                    0 === g ||
                        ...
                        ((m = function (e, t) {
                            d || v.updateStack(e, void 0),
                                v.uploadLog.push(t),
                                v._checkAsyncComplete() &&
                                    (v.fileBatchCompleted = !0);
                        }),
                        (o = function () {
                            var e,
                                i,
                                        ...
                                        if (
                                            ...
                                            for (
                                                ...
                                                (a = i + n),
                                                    ...
                                                    o.tags.length &&
                                                        (o.tags[a] = r.tags[i]);
                                            (v.initialPreview = t.cleanArray(
                                                o.content
                                            )),
                                                (v.initialPreviewConfig =
                                                    t.cleanArray(o.config)),
                                                (v.initialPreviewThumbTags =
                                                    t.cleanArray(o.tags));
                                        } else
                                ...
                                setTimeout(function () {
                                    a && m(i, w),
                                        ...
                                        v._setProgress(
                                            101,
                                            b,
                                            v.msgAjaxProgressError.replace(
                                                "{operation}",
                                                s
                                            )
                                        ),
            ...
            _uploadBatch: function () {
                var i,
                    ...
                    c = {},
                    p =
                        l.filestack.length > 0 ||
                        !e.isEmptyObject(l.uploadExtraData);
                    ...
                    n._abort(o) ||
                        ((e = function (e) {
                            ...
                            n._raise("filebatchpreupload", [t]),
                                ...
                                (o.xhr = e),
                                n._abort(o) &&
                                    (e.abort(), n._setProgressCancelled());
                        }),
                        (i = function (e, i, a) {
                        ...
                        (r = function (e, t, i) {
                            ...
                            (o.data = a),
                                ...
                                n._setProgress(
                                    101,
                                    n.$progress,
                                    n.msgAjaxProgressError.replace(
                                        "{operation}",
                                        r
                                    )
                                );
                    ...
                    a.find(n).each(function () {
                        ...
                        if (!t.isEmpty(u) && void 0 !== f) {
                            ...
                            (b = parseInt(b.replace("init_", ""))),
                                (g =
                                    t.isEmpty(_.config) &&
                                    t.isEmpty(_.config[b])
                                        ? null
                                        : _.config[b]),
                                (h =
                                    t.isEmpty(g) || t.isEmpty(g.extra)
                                        ? r
                                        : g.extra),
            ...
            _hideFileIcon: function () {
                var e = this;
                e.overwriteInitial &&
                    e.$captionContainer.removeClass("icon-visible");
            },
            ...
            _generatePreviewTemplate: function (
                ...
                var f,
                    ...
                    b =
                        400 > _
                            ? v.previewSettingsSmall[i] ||
                              v.defaults.previewSettingsSmall[i]
                            : v.previewSettings[i] ||
                              v.defaults.previewSettings[i],
            ...
            _getResizedImage: function (i, a, r) {
                ...
                try {
                    C.drawImage(f, 0, 0, m, v),
                        ...
                        a.val++,
                        a.val === r &&
                            u._raise("fileimagesresized", [void 0, void 0]),
                        n instanceof Blob ||
                            d(
                                u.msgImageResizeError,
                                { id: x, index: T },
                    ...
                    a.val++,
                        a.val === r &&
                            u._raise("fileimagesresized", [void 0, void 0]),
                        (c = u.msgImageResizeException.replace(
                            "{errors}",
                            k.message
                        )),
                ...
                if (!a.changeTriggered) {
                    ...
                    if (
                        ...
                        a.dropZoneEnabled &&
                            a.$container
                                .find(
                                    ".file-drop-zone ." + a.dropZoneTitleClass
                                )
                                .remove(),
                        s
                            ? e.each(c, function (e, t) {
                ...
                return (
                    ...
                    t.required && !t.getFilesCount()
                        ? (t.$errorContainer.html(""),
                          ...
                          !1)
                        : t.minFileCount > 0 &&
                          t._getFileCount(e) < t.minFileCount
                        ? (t._noFilesError({}), !1)
                        : !0
                );
            },
            ...
            readFiles: function (i) {
                ...
                var a,
                    ...
                    b =
                        r.maxFilePreviewSize &&
                        parseFloat(r.maxFilePreviewSize),
            ...
            lock: function () {
                ...
                return (
                    ...
                    e.disable(),
                    e.showRemove &&
                        e.$container.find(".fileinput-remove").hide(),
                    e.showCancel &&
                        e.$container.find(".fileinput-cancel").show(),
            ...
            unlock: function (e) {
                ...
                return (
                    ...
                    t.enable(),
                    t.showCancel &&
                        t.$container.find(".fileinput-cancel").hide(),
                    t.showRemove &&
                        t.$container.find(".fileinput-remove").show(),
                    e && t._resetFileStack(),
